...
void initObjects() {
	...
	scene.LoadModel("objects/scene/seahorse/seahorse/seahorse.obj");
	//wolf.LoadModel("objects/wolf/wolf.glb");
...
void renderScene() {
	...
	if (showDepthMap) {
		...
		model = lightRotation;
		model = glm::translate(model, 20.0f * lightDir);
